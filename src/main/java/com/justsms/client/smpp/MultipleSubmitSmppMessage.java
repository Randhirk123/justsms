package com.justsms.client.smpp;
...
import com.justsms.client.model.DeliveryReceiptState;

public class MultipleSubmitSmppMessage {

	private static final Logger LOGGER = LoggerFactory.getLogger(MultipleSubmitSmppMessage.class);
	
	private static final TimeFormatter TIME_FORMATTER = new AbsoluteTimeFormatter();
	
	 private final String smppIp ="103.153.58.106";
	 
	    private int port = 4444;
	 
	    private final String username = "justpropg.pro";
	 
	    private final String password = "gZPGb";
	    ...
	    private Address[] prepareAddress(List numbers) {
	        ...
	        for(int i = 0; i< numbers.size(); i++){
	            addresses[i]= new Address(TypeOfNumber.NATIONAL, NumberingPlanIndicator.UNKNOWN, numbers.get(i).toString());
	        }
	        return addresses;
	    }
		...
		/*
		 * public static void main(String[] args) { MultipleSubmitSmppMessage
		 * multiSubmit = new MultipleSubmitSmppMessage();
		 * multiSubmit.broadcastMessage("Test message from Randhir",
		 * Arrays.asList("9973288807")); }
		 */
}
